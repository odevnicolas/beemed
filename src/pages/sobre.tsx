  ...
  return (
    <div>
      ...
      <div className="-z-20 relative">
        ...
        <div className="flex justify-center items-center 2xl:-mt-[38%] 2xl:z-99 xl:z-99 xl:-mt-[58%] lg:-mt-[75%] lg:z-20 md:-mt-[80%] sm:-mt-[85%] xsm:-mt-[90%] md:z-20">
      ...
      <div className="ml-[13%] 2xl:mt-[18%] xl:mt-[18%] lg:mt-[18%] md:mt-[25%] sm:mt-[35%] xsm:mt-[45%] bg-[#9BF798]  rounded-3xl w-[71%] h-[1%] z-10">
        <div className=" px-[7%] py-[4%]">
          <p className="text-[16px] leading-8 font-normal xl:text-sm">
          ...
          <div className=" float-right -mt-[29%] mr-[3%] xl:mr-0 lg:invisible md:invisible sm:invisible xsm:invisible">
            <img
