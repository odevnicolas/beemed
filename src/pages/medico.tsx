  ...
  return (
    ...
    <div className="relative -mt-28 ">
      <div>
        ...
        <img src="med-banner.png" height={900} width={700} className="2xl:w-[800px] lg:w-[600px] md:w-[500px] sm:w-[450px] acer:w-[900px]"></img>
        </div>
        <div className="">
            <h2 className="text-colorGreen text-5xl mr-44 md:relative md:-mt-[200px] md:flex md:justify-end leading-[48px] font-normal 2xl:relative 2xl:-mt-[330px] 2xl:flex 2xl:justify-end 2xl:mr-80 lg:text-4xl lg:mr-16 md:text-3xl md:mr-0 sm:ml-56 acer:mr-[240px] acer:-mt-[380px]">
              Transforme <br/>a saúde conosco
            </h2>
            <p className=" text-2xl mr-40 md:mt-4 md:relative md:flex md:justify-end text-white font-normal leading-10 2xl:mt-4 2xl:relative 2xl:flex 2xl:justify-end 2xl:mr-72 lg:text-xl lg:mr-7 md:mr-0 md:text-sm sm:ml-56 acer:mr-[205px]">
...
[]       <FormMedico/>
        ...
        <div className=" bg-ColorFooter">
          ...
          <div className="justify-center items-center">
           ...
           <p className="ml-44 text-white text-xl leading-[60px] font-normal mt-6 sm:text-base acer:leading-10 acer:ml-44">
