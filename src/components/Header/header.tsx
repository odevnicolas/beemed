    ...
    <Fragment>
      ...
      <header className="flex justify-between items-center py-[1.3%] px-[2%] mt-[1.3%]">
        ...
        <div className="ml-[9%] flex gap-10 z-10">
          ...
          <button
            className="text-black font-medium mt-[1%] hover:underline decoration-solid decoration-colorButton decoration-2 box-decoration-clone"
            onClick={handleOpenModal}
          >
            Login
          </button>
          <Link className="mt-[1.2%]" href="/cirurgias">
            <button className="text-black btn-procedimentos ml-5 font-NowAltRegular">
              Procedimentos
            </button>
          </Link>
        </div>
